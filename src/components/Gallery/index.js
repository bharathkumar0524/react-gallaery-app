...
class Gallery extends Component {
  ...
  displayThumbnailImageUrl = (imgUrl, altText) => {
    this.setState({imageUrl: imgUrl, imageAltText: altText})
  }
    ...
    return (
      <div className="Gallery-app-container">
        <div className="gallery-container">
          <img src={imageUrl} alt={imageAltText} className="img-view" />
          ...
          <ul className="thumbnail-items">
            {imagesList.map(eachItem => (
              <ThumbnailItem
                ...
                key={eachItem.id}
                displayThumbnailImageUrl={this.displayThumbnailImageUrl}
                isActive={imageUrl === eachItem.imageUrl}
              />
            ))}
          </ul>
        </div>
